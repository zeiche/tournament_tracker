...
def list_capabilities() -> Dict[str, Any]:
    ...
    return {
        'models': list(capability_registry.models.keys()),
        'services': list(capability_registry.services.keys()),
        'functions': list(capability_registry.capabilities.keys())
    }


def get_capability_info(capability_name: str) -> Dict[str, Any]:
    """Get detailed info about a specific capability."""
    if capability_name in capability_registry.models:
        return capability_registry.models[capability_name]
    elif capability_name in capability_registry.services:
        return {'service': capability_name, 'getter': capability_registry.services[capability_name]}
    elif capability_name in capability_registry.capabilities:
        return {'functions': capability_registry.capabilities[capability_name]}
    return {}
